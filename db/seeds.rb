...
cocktail1 = Cocktail.create!(
  name: 'Bloody Mary',
  description: 'A Bloody Mary is a cocktail containing vodka, tomato juice, and combinations of other spices and flavorings including Worcestershire sauce, hot sauces, garlic, herbs, horseradish, celery, olives, etc.',
...
cocktail2 = Cocktail.create!(
  name: 'Screwdriver',
  description: 'A screwdriver is a popular alcoholic highball drink made with orange juice and vodka. While the basic drink is simply the two ingredients, there are many variations. ',
...
cocktail4 = Cocktail.create!(
  name: 'Manhattan',
  description: 'A Manhattan is a cocktail made with whisky, sweet vermouth and bitters. While rye is the traditional whiskey of choice, other commonly used whiskies include Canadian whisky, bourbon, etc.',
...
cocktail5 = Cocktail.create!(
  name: 'Moscow Mule',
  description: 'A Moscow mule is a cocktail made with vodka, spicy ginger beer, and lime juice, garnished with a slice or wedge of lime. It is a type of buck and therefore sometimes known as a vodka buck.',
...
cocktail6 = Cocktail.create!(
  name: 'Margarita',
  description: 'A margarita is a cocktail consisting of tequila, orange liqueur, and lime juice often served with salt on the rim of the glass. The drink is served shaken with ice, blended with or without ice.',
...
cocktail7 = Cocktail.create!(
  name: 'Mojito',
  description: 'Mojito is a traditional Cuban highball. Its combination of sweetness, citrus, and herbaceous mint flavors is intended to complement the rum, and has made the mojito a popular summer drink.',
...
cocktail8 = Cocktail.create!(
  name: 'Negroni',
  description: 'The Negroni is a popular Italian cocktail, made of gin, vermouth rosso, Campari, and garnished with orange peel. A Negroni is stirred, and then strained into a chilled cocktail glass over ice.',
